...
$ip = "192.168.0.101";
// Dynamically mimic the current URL path but point to public_register_employee.php
$public_url = $protocol . "://" . $ip . str_replace('generate_qr_employee.php', 'public_register_employee.php', $_SERVER['PHP_SELF']);
?>
...
<head>
    ...
    <title>Employee Registration QR Code - Clinic System</title>
...
<body>
    <div class="container py-5">
        ...
        <div class="qr-card">
            <div class="qr-info">
                <h1>Employee Registration QR</h1>
                <p>Scan to register employee information.</p>
                <div class="url-box">
                    <?php echo $public_url; ?>
                </div>
            </div>
            ...
            <div class="no-print">
                <div class="btn-group">
                    <a href="employees.php" class="action-btn btn-back">
    ...
    <script>
        ...
        function downloadQR() {
            ...
            link.download = 'Employee_Registration_QR.png';
